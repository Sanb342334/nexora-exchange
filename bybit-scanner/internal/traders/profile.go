...
func DefaultProfiles(base config.RiskConfig) []Profile {
	return []Profile{
		...
		},
		{
			...
			Strategy: "carry_arbitrage", ExecutionMode: ExecutionDemoAggregate,
			MinScore: 15, MinVol1mUSDT: 0, MinTriggers: 0,
			LeverageMax: 2, RiskMult: 0.35, MaxOpen: 8, MinRR: 0.3,
		...
		},
		{
			...
			Strategy: "indicator_mtf", ExecutionMode: ExecutionDemoAggregate,

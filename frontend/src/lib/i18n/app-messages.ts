...
export const APP_EN: AppMessages = {
  ...
  trade: {
    hero: {
      badge: 'Spot · Futures · P2P',
      title: 'Trade with professional charts',
      subtitle: 'Spot and USDT-margined futures on BTC, ETH, XRP and more — one secure terminal.',
      line1: 'Real-time order book, TradingView charts, and instant execution.',
      line2: 'Isolated margin futures with up to 20× leverage.',
      ctaPrimary: 'Start spot trading',
...
export const APP_TRANSLATIONS: Partial<Record<LocaleId, AppMessagesPatch>> = {
  ru: {
    ...
    trade: {
      hero: {
        badge: 'Спот · Фьючерсы · P2P',
        title: 'Торгуйте с профессиональными графиками',
        subtitle: 'Спот и фьючерсы с маржой в USDT по BTC, ETH, XRP и другим — в одном терминале.',
        line1: 'Стакан в реальном времени, графики TradingView и мгновенное исполнение.',
        line2: 'Изолированная маржа до 20× на фьючерсах.',
        ctaPrimary: 'Начать спот-торговлю',
